...
| --- | --- | --- | --- |
| Pencil, Ink pen, Technical pen, Paintbrush, Airbrush, Marker | `Brush(preset)` | `DabPass` → stroke buffer → merge on pen-up | active layer |
...
| Technical pen | 2.5 (0.5–20) | 1.0 | 1.0 | 1.0 | 0.08 | Round / Fixed | 0.55 | off | – |
...
- **Technical pen.** A small round tip ignores pressure for a constant-width,
  opaque construction line. Moderate stabilization removes digitizer noise
  without the slower response used for expressive ink.
