...
| **Photo editing** (adjustments, filters, crop of imported photos) | Different tool, different UX, huge surface. Import-as-layer is the only photo feature we will ever want. | Import image as layer/reference is post-v1. Crop/resize of the *canvas* is post-v1. |
