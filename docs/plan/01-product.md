...
| A4 | Chrome text and icons meet **WCAG AA contrast (4.5:1 text, 3:1 icons)** in every `AppTheme`; each accent is checked against every surface where it appears | table-driven contrast check on `ui/theme` tokens |
