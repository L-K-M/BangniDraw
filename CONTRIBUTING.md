...
Read first, in order: [PLAN.md](PLAN.md) (what and why, plus the index of
`docs/plan/`), [AGENTS.md](AGENTS.md) (how this repo operates),
[CICD.md](CICD.md) (pipelines).
...
- **No secrets in the repo.** The checked-in debug keystore is the sole,
  documented exception (docs/decisions/0005).
- **No permissions.** Especially not INTERNET (PLAN.md §9). A permission
  is a product decision → ADR first.
- **Mixbox stays attributed and non-commercial** (docs/decisions/0003).
  Any new third-party code or asset needs a public-domain/CC0 license or
  its own ADR.
...
Every PR is auto-reviewed by GLM. Maintainers (usually agents) triage
